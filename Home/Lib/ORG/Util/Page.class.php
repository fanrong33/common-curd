...
class Page {
    ...
    public function shows(){
        ...
        // 上一页
        if ($upRow>0){
             $pages.=   "<li><a href='".str_replace('__PAGE__',$upRow,$url)."' class='prev'>".$this->config['prev']."</a></li>";
        }else{
             $pages.=   "<li class='disabled'><a>".$this->config['prev']."</a></li>";
        }
         
        //第一页
        if($this->nowPage>($adjacents+1)) {
            $pages.= "<li><a href='".str_replace('__PAGE__',1,$url)."'>1</a></li>";
        }
        ...
        for($i=$pmin; $i<=$pmax; $i++) {
            if($i==$this->nowPage) {
                ...
                $pages.= "<li><a href='".str_replace('__PAGE__',$i,$url)."'>".$i."</a></li>";
            }
        }
        ...
        if($this->nowPage<($this->totalPages-$adjacents)) {
            ...
            $pages.= "<li><a href='".str_replace('__PAGE__',$this->totalPages,$url)."'>".$this->totalPages."</a></li>";
        }
         
        // 下一页
        if ($downRow <= $this->totalPages){
             $pages.=   "<li><a href='".str_replace('__PAGE__',$downRow,$url)."' class='next'>".$this->config['next']."</a></li>";
        }else{
            $pages.=   "<li class='disabled'><a>".$this->config['next']."</a></li>";
        }
        return $pages;
    }
