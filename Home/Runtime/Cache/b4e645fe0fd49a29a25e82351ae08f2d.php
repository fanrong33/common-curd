...
<body>
    ...
    <section>
      ...
      <li <?php if(strtolower(MODULE_NAME) == 'landingpage'): ?>class="active"<?php endif; ?> ><a href="<?php echo U('LandingPage/index');?>">页面</a></li>
      <li <?php if(strtolower(MODULE_NAME) == 'group'): ?>class="active"<?php endif; ?> ><a href="<?php echo U('Group/index');?>">分组</a></li>
                ...
                <div class="col-xs-10">
                    ...
                    <div style="margin-bottom: 20px;">
                        <form id="landing_page_form" action="<?php echo U('LandingPage/index');?>" method="GET">
                            <a class="btn btn-default" href="<?php echo U('LandingPage/add');?>" style="margin-right: 5px;">添加页面</a>
                    ...
                    <table class="table table-bordered table-hover" id="landing_page_list">
                        <thead>
                            <tr>
                                <td>
                        ...
                        <tbody>
                            <?php if($list): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rs): $mod = ($i % 2 );++$i;?><tr id="landing_page_<?php echo ($rs['id']); ?>">
                                    ...
                                    <td>
                                        <a href="<?php echo U('LandingPage/edit', array('id'=>$rs['id']));?>">编辑</a> &nbsp;<span class="text-muted">|</span>&nbsp;
                                        <a href="javascript:;" onclick="delete_landing_page(<?php echo ($rs['id']); ?>)">删除</a>
                                    </td>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#group_id_dropdown").delegate("a", 'click', function(){
                ...
                $("#landing_page_form").submit();
            });


            // bind sort event
            $("#landing_page_list").delegate('.sort', 'click', function(){
                var $this = $(this);
